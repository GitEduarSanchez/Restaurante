...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-warning">
                <h4 class="card-title text-white"><i class="fa fa-tasks"></i> Gestión de Mesas</h4>
            </div>
    ...
    <div class="row">
        ...
        <h4 class="card-subtitle m-0 text-dark"><i class="font-20 fa fa-save"></i> Gestión de Mesas</h4><hr>
        ...
        <h4 class="card-subtitle m-0 text-dark"><i class="font-20 fa fa-tasks"></i> Control Mesas</h4><hr>
