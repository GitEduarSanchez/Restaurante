                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group has-feedback">
                            ...
                            <select name="ivacombo" id="ivacombo" class="form-control" required="" aria-required="true">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group has-feedback">
                    ...
                    <input type="text" class="form-control agregaproducto" name="search_producto_combos" id="search_producto_combos" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Realice la Búsqueda de Producto" autocomplete="off"/>
