        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group has-feedback">
                    ...
                    <?php
                    $usuario = new Login();
                    $usuario = $usuario->ListarResponsables();
                    if($usuario==""){ 
                        echo "";
                    } else {
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" name="hasta" id="hasta" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Fecha Hasta" autocomplete="off" required="" aria-required="true"/>  
                    ...
                    <div class="text-right">
                        <button type="button" onClick="BuscaComisionxVentas()" class="btn btn-warning"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
