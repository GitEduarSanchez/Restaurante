...
if(isset($_SESSION['acceso'])) { 
    if ($_SESSION['acceso'] == "administrador" || $_SESSION["acceso"]=="secretaria" || $_SESSION["acceso"]=="cajero" || $_SESSION["acceso"]=="cocinero") {
            ...
            <div class="form-body">
                ...
                <!--<div class="row"> 
                    <div class="col-md-12"> 
                      ...
                      <input type="text" name="bproductos" id="bproductos" onKeyUp="this.value=this.value.toUpperCase();" class="form-control" placeholder="Ingrese Criterio para tu Búsqueda" autocomplete="off" required="" aria-required="true">
