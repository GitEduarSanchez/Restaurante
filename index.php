...
<meta name="author" content="Eduar Sanchez">
    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url(assets/images/bg-home.png); position: absolute; height: 100%; width: 100%; top: 0; left: 2px;">
              ...
              <div id="loginform">
                ...
                <div class="logo">
                  <span class="db"><?php if (file_exists("fotos/logo-principal.png")){
                    echo "<img src='fotos/logo-principal.png' width='86%' border-radius: 50%; height='140px' alt='Logo Principal'>"; 
                            } else {
            ...
            <div id="recoverform">
              <div class="logo">
                <span class="db"><?php if (file_exists("fotos/logo-principal.png")){
                    echo "<img src='fotos/logo-principal.png' width='86%' height='64px' alt='Logo Principal'>"; 
                            } else {
                    echo "<img src='' width='86%' height='64px' alt='Logo Principal'>"; 
                            } 
                    ?></span>
