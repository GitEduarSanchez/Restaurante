        ...
        <div class="row">
           <div class="col-md-6">
                <div class="form-group has-feedback">
                    ...
                    <input type="text" class="form-control" name="numfactura" id="numfactura" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Realice la Búsqueda por Nº de Documento" autocomplete="off" required="" aria-required="true"/> 
            ...
            <div class="col-md-4">
               <div class="form-group has-feedback">
                ...
                <select name="codarqueo" id="codarqueo" class='form-control' required="" aria-required="true">
