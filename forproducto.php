                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="name2" name="favorito" value="0" <?php if (isset($reg[0]['favorito'])) { ?> <?php if($reg[0]['favorito'] == "0") { ?> value="0" checked="checked" <?php } } else { ?> checked="checked" <?php } ?> class="custom-control-input">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <br>
                            <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="control1" name="controlstockp" value="1" <?php if (isset($reg[0]['controlstockp']) && $reg[0]['controlstockp'] == "1") { ?> checked="checked" <?php } ?> class="custom-control-input">
                            <label class="custom-control-label" for="control1">SI</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="control2" name="controlstockp" value="0" <?php if (isset($reg[0]['controlstockp'])) { ?> <?php if($reg[0]['controlstockp'] == "0") { ?> value="0" checked="checked" <?php } } else { ?> checked="checked" <?php } ?> class="custom-control-input">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group has-feedback">
                    ...
                    <input type="text" class="form-control agregaingrediente" name="busquedaingrediente" id="busquedaingrediente" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Realice la Búsqueda de Ingrediente" autocomplete="off"/>
