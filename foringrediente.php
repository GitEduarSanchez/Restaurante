            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="control2" name="controlstocki" value="0" <?php if (isset($reg[0]['controlstocki'])) { ?> <?php if($reg[0]['controlstocki'] == "0") { ?> value="0" checked="checked" <?php } } else { ?> checked="checked" <?php } ?> class="custom-control-input">
