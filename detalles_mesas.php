...
if (isset($_GET['CargaPedidosMesa']) && isset($_GET['codmesa']) && isset($_GET['codpedido'])):
...
?>
    ...
    <div class="row-horizon">
        <span style="font-size: 16px;" class="categorias <?php if(decrypt($_GET['codpedido']) == '0' || $_GET['codpedido'] == '0' || $_GET['codpedido'] == '0'){ ?> selectedGat <?php } else { ?> <?php } ?>" onClick="VerificaMesa('<?php echo encrypt($reg[0]['codmesa']);?>','0');"><i class="fa fa-plus-circle"></i></span>
        <?php 
        $a=1;
...
if (isset($_GET['BuscaPedidosMesa']) && isset($_GET['codmesa']) && isset($_GET['codpedido']) && isset($_GET['codventa'])){
...
?>
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <button type="button" class="btn btn-warning btn-lg btn-block waves-effect waves-light" onClick="CerrarMesa('<?php echo encrypt($detalle[0]["codpedido"]) ?>','<?php echo encrypt($detalle[0]["codventa"]) ?>','<?php echo encrypt($detalle[0]["codmesa"]) ?>','<?php echo encrypt("CERRARMESA") ?>')" title="Cerra Mesa"><span class="mdi mdi-black-mesa"></span> Cerrar Mesa</button>
    </div>
    
    <div class="col-md-4">
      <button type="button" class="btn btn-dark btn-lg btn-block" onClick="CancelarPedidoMesa('<?php echo encrypt($detalle[0]["codpedido"]) ?>','<?php echo encrypt($detalle[0]["codventa"]) ?>','<?php echo encrypt($detalle[0]["codmesa"]) ?>','<?php echo encrypt("CANCELARPEDIDO") ?>')" title="Cancelar Pedido"><span class="fa fa-trash-o"></span> Cancelar</button>
    </div>
  </div>  
...
if (isset($_GET['BuscaDetallesPedidosMesa']) && isset($_GET['codmesa'])) {
...
if (isset($_GET['CargaModalCierreVenta']) && isset($_GET['codmesa']) && isset($_GET['codpedido']) && isset($_GET['codventa']) && isset($_GET['totalpago'])) {
