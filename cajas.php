...
<!-- sample modal content -->
<div id="myModalCajas" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-warning">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="btn-group m-b-20">
                            <button type="button" class="btn btn-success btn-light" data-placement="left" title="Nueva Caja" data-original-title="" data-href="#" data-toggle="modal" data-target="#myModalCajas" data-backdrop="static" data-keyboard="false"><i class="fa fa-plus"></i> Nuevo</button>
