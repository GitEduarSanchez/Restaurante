...
<ul class="nav nav-tabs" role="tablist">
    <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#home" role="tab"><span class="hidden-sm-up"><i class="mdi mdi-bank"></i></span> <span class="hidden-xs-down">Datos de Empresa</span></a> </li>
    <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#profile" role="tab"><span class="hidden-sm-up"><i class="mdi mdi-note-multiple"></i></span> <span class="hidden-xs-down">Datos de Documentos</span></a> </li>
    <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#messages" role="tab"><span class="hidden-sm-up"><i class="mdi mdi-image"></i></span> <span class="hidden-xs-down">Logos de Empresa</span></a> </li>
</ul>

<!-- Tab panes -->
<div class="tab-content">
    
    <div class="tab-pane p-4 active" id="home" role="tabpanel"><!--if panel 1-->
        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group has-feedback">
                        <label class="control-label">Moneda para Cambio: <span class="symbol required"></span></label>
                        <i class="fa fa-bars form-control-feedback"></i>
    ...
    <div class="tab-pane  p-4" id="profile" role="tabpanel"><!-- if panel 2 -->
            ...
            <div class="row"> 
                <div class="col-md-3">
                    <div class="form-group has-feedback">
                        ...
                        <input type="text" class="form-control" name="nroactividadsucursal" id="nroactividadsucursal" onKeyUp="this.value=this.value.toUpperCase();" value="<?php echo $reg[0]['nroactividadsucursal']; ?>" autocomplete="off" placeholder="Ingrese Nº de Actividad" required="" aria-required="true">
                        <i class="fa fa-pencil form-control-feedback"></i> 
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group has-feedback">
                        ...
                        <input type="number" min="1" step="1" class="form-control number" name="inicioticket" id="inicioticket" onKeyUp="this.value=this.value.toUpperCase();" value="<?php echo $reg[0]['inicioticket']; ?>" autocomplete="off" placeholder="Ingrese Nº de Inicio de Ticket" required="" aria-required="true">
                        <i class="fa fa-bolt form-control-feedback"></i> 
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group has-feedback">
                        ...
                        <input type="number" min="1" step="1" class="form-control number" name="inicioboleta" id="inicioboleta" onKeyUp="this.value=this.value.toUpperCase();" value="<?php echo $reg[0]['inicioboleta']; ?>" autocomplete="off" placeholder="Ingrese Nº de Inicio de Boleta" required="" aria-required="true">
                        <i class="fa fa-bolt form-control-feedback"></i> 
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group has-feedback">
                        ...
                        <input type="number" min="1" step="1" class="form-control number" name="iniciofactura" id="iniciofactura" onKeyUp="this.value=this.value.toUpperCase();" value="<?php echo $reg[0]['iniciofactura']; ?>" placeholder="Ingrese Nº Inicio de Factura" autocomplete="off" required="" aria-required="true"/> 
                        <i class="fa fa-bolt form-control-feedback"></i>  
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group has-feedback">
                        ...
                        <input type="number" min="1" step="1" class="form-control number" name="inicionota" id="inicionota" onKeyUp="this.value=this.value.toUpperCase();" value="<?php echo $reg[0]['inicionota']; ?>" placeholder="Ingrese Nº Inicio Nota de Crédito" autocomplete="off" required="" aria-required="true"/> 
                        <i class="fa fa-bolt form-control-feedback"></i>  
                    </div>
                </div> 
            ...
            <div class="row">
                <div class="col-md-3"> 
                    <div class="form-group has-feedback"> 
                        <label class="control-label">Propina Sugerida (%): <span class="symbol required"></span></label> 
                        <input type="text" class="form-control" name="propinasugerida" id="propinasugerida" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '2', '.', '')" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Propina Sugerida (%)" value="<?php echo $reg[0]['propinasugerida']; ?>" required="" aria-required="true">
                        <i class="fa fa-pencil form-control-feedback"></i>  
                    </div> 
                </div>
                ...
                <!--<div class="col-md-3">
                        <div class="form-group">
                            <label class="control-label">Procesar Documentos Electrónicos: <span class="symbol required"></span></label> 
                            <br>
                            <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="name1" name="infoapi" value="SI" <?php if (isset($reg[0]['infoapi']) && $reg[0]['infoapi'] == "SI") { ?> checked="checked" <?php } ?> class="custom-control-input">
                            <label class="custom-control-label" for="name1">SI</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="name2" name="infoapi" value="NO" <?php if (isset($reg[0]['infoapi'])) { ?> <?php if($reg[0]['infoapi'] == "NO") { ?> value="0" checked="checked" <?php } } else { ?> checked="checked" <?php } ?> class="custom-control-input">
    ...
    <div class="tab-pane p-4" id="messages" role="tabpanel"><!-- if panel 3 -->
                  ...
                  <div class="fileinput fileinput-new" data-provides="fileinput">
                      <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 120px; height: 110px;">
                        <?php if (file_exists("fotos/logo-principal.png")){
                            echo "<img src='fotos/logo-principal.png' class='img-rounded' border='0' width='120' height='110' title='Logo' data-rel='tooltip'>"; 
                        } else {
