...
$(document).ready(function() {
    ...
    function AgregaCompras () {
        ...
        function(data, textStatus) {
            ...
            "<td><label>" + item.txtCodigo + "</label></td>" +
            "<td class='text-left'><h5><label>" + item.producto + "</label></h5><small>(" + item.categorias + ")</small></td>" +
            "<td><label>" + item.precio + "</label></td>" +
            "<td><label>" + ValorTotal.toFixed(2) + "</label></td>" +
            "<td><label>" + Descuento.toFixed(2) + "<sup>" + item.descproductofact + "%</label></sup></td>" +
            "<td><label>" + item.ivaproducto + "</label></td>" +
            "<td><label>" + Operacion.toFixed(2) + "</label></td>" +
            "<td>" +
