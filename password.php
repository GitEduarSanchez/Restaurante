            ...
            <div class="page-breadcrumb border-bottom">
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
                        ...
                        <?php echo $var = ($_SESSION['acceso'] == "mesero" || $_SESSION['acceso'] == "cocinero" || $_SESSION['acceso'] == "repartidor" ? "<li class='breadcrumb-item' aria-current='page'><a href='panel' class='text-info'> Mostrador</a></li>" : "<li class='breadcrumb-item'>Administración</li>"); ?>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" class="form-control" name="dni" id="dni" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Nº de Documento" autocomplete="off" value="<?php echo $_SESSION['dni']; ?>" disabled="disabled" aria-required="true"/> 
